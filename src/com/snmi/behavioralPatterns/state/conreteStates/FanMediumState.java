...
public class FanMediumState extends State {
     ...
     * Constants
     */
    private static final String FAN_NEXT_STATE = "Turning fan on to high.";
    private static final String FAN_CURRENT_STATE = "Fan is on medium.";
